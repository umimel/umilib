#ifndef MAXPLS_CNV_HPP
#define MAXPLS_CNV_HPP
...
// bが上に凸
vector<pair<int, ll>> max_plus_convolution(const vector<ll> &a, const vector<ll> &b){
    ...
    return monotone_minima<ll, greater<ll>>(n+m-1, n, f);
}
#endif